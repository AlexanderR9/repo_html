...
class PosManagerObj
{
	    ...
	    this.pid_list = []; // динамический массив, заполняется взависимости от задачи, список PID всех/выборочных поз кошелька
	...
	//pool_addrs - список адресов пулов которые состветствуют списку this.pid_list
	...
	//запрашивает данные всех позиций из текущей сети. предварительно запрашивает PID_LIST.
	//далее кусками, по n_sep записей поз получает из текущей сети.
